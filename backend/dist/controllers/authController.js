...
import { userRegistrationSchema, userLoginSchema, forgotPasswordSchema, resetPasswordSchema, changePasswordSchema } from '../utils/validation.js';
/**
...
export const verifyEmail = async (req, res, next) => {
    try {
        ...
        const user = users.find(u => u.emailVerificationToken &&
...
export const resetPassword = async (req, res, next) => {
    try {
        ...
        const user = users.find(u => u.passwordResetToken &&
