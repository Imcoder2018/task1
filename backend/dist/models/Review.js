...
reviewSchema.post('findOneAndUpdate', async function () {
    if (this.getUpdate()) {
        await this.model.calcAverageRatings(this.getQuery().tour);
    }
});
...
reviewSchema.statics.getTourReviews = function (tourId, page = 1, limit = 10, sortBy = 'createdAt', sortOrder = 'desc') {
...
reviewSchema.statics.getReviewsByRating = function (minRating = 1, maxRating = 5) {
    return this.find({
...
// Get recent reviews
reviewSchema.statics.getRecentReviews = function (days = 30, limit = 10) {
...
reviewSchema.statics.searchReviews = function (searchTerm) {
    return this.find({
...
reviewSchema.statics.getTourRatingBreakdown = async function (tourId) {
