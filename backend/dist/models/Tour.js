...
const tourSchema = new Schema({
    ...
    guides: [{
            ...
            ref: 'User',
            validate: {
                validator: async function (guideId) {
...
tourSchema.statics.getMonthlyPlan = async function (year) {
...
tourSchema.statics.getToursWithin = function (distance, latlng, unit = 'km') {
...
tourSchema.statics.getDistances = function (latlng, unit = 'km') {
