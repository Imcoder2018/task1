...
const blogSchema = new Schema<IBlogDocument>({
  ...
  publishedAt: {
    type: Date,
    validate: {
      validator: function(publishedAt: Date) {
...
blogSchema.statics.getPublished = function(
  ...
  const filter: any = { status: BlogStatus.PUBLISHED };
...
// Search blogs
blogSchema.statics.searchBlogs = function(
  searchTerm: string,
  filters: {
    category?: BlogCategory;
    tags?: string[];
...
blogSchema.statics.getPopular = function(limit: number = 10, days?: number) {
...
// Get blogs by tag
blogSchema.statics.getByTag = function(
  tag: string,
  page: number = 1,
  limit: number = 10
) {
...
blogSchema.statics.incrementViews = function(blogId: string) {
